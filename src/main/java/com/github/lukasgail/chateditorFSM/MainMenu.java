...
public class MainMenu implements EditorState{
    ...
    public void chatInterface(){
        ...
        line6 = new TextComponent(ChatColor.AQUA + "[6] ActivatorButton(s): "+ ChatColor.GOLD + editorMachine.getRedstoneButtonNeverNull(editorMachine.getRedstoneButton()));//Add remove option for block
        ...
        line8 = new TextComponent(ChatColor.AQUA + "[8] GateOptions: (BlockMaterial, Permeability,...)"); //BlockMaterial, Permeability, MoveDistance, Repetitions  //line4 = new TextComponent(ChatColor.AQUA + "[4] BlockMaterial: " + ChatColor.GOLD + editorMachine.getMaterial().toString());  //line5 = new TextComponent(ChatColor.AQUA + "[5] Permeable: " + ChatColor.GOLD + editorMachine.isPermeable());  //line6 = new TextComponent(ChatColor.AQUA + "[6] MoveDistance: " + ChatColor.GOLD + editorMachine.getMoveDistance());  //line7 = new TextComponent(ChatColor.AQUA + "[7] Repetitions: " + ChatColor.GOLD + editorMachine.getRepetitions());
